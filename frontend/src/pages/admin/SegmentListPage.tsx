...
import { Plus, Edit, BookOpen, Search, Archive } from 'lucide-react';
...
export function SegmentListPage() {
  ...
  function getRowActions(segment: Segment): ActionMenuItem[] {
    ...
    // Show Archive action for non-archived segments
  ...
  return (
    <div className="py-4 lg:px-8">
      ...
      <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl font-bold text-navy">Content Management</h1>
        </div>
        <button
      ...
      {/* Controls: Search and Show Archived */}
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative flex-1 sm:max-w-xs">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 rounded-lg border border-muted-200 text-helper text-muted-800 placeholder:text-muted-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary transition-colors"
          />
        </div>

        {/* Status Filter + Show Archived */}
